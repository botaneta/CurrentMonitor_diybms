...
bool ads1115_setupContinuousAmpereSampling()
{
    ...
    ads.setSampleRate(ADS1115_REG_CONFIG_DR_64SPS);
...
void ads1115_loop()
{
    ...
    */
    ...
    else if( ads1115_mode == ADS1115_MODE_VOLTAGE )
    {
        ...
        lastVoltage_mV = (uint32_t)max(0,ads_mV) * (1206000+4700) / 4700;   // this barely fits into uint32_t as max of this var would be 4126105600 or 0xF5EF6000
